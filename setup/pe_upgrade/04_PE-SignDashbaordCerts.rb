...
on dashboard, 'cd /opt/puppet/share/puppet-dashboard;' +
  '/opt/puppet/bin/rake --trace RAILS_ENV=production cert:request'

on master, puppet('cert --sign dashboard')

on dashboard, 'cd /opt/puppet/share/puppet-dashboard;' +
  '/opt/puppet/bin/rake --trace RAILS_ENV=production cert:retrieve'

on dashboard, 'cd /opt/puppet/share/puppet-dashboard;' +
  "/opt/puppet/bin/retrieve_certs.rb #{master} #{dashboard}"
